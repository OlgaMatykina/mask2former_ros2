...
bool segm_msgs__msg__mask__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * segm_msgs__msg__mask__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool segm_msgs__msg__obstacles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("segm_msgs.msg._obstacles.Obstacles", full_classname_dest, 34) == 0);
  }
  segm_msgs__msg__Obstacles * ros_message = _ros_message;
  {  // header
  ...
  {  // classes_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "classes_ids");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->classes_ids.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'classes_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // masks
    ...
    if (!segm_msgs__msg__Mask__Sequence__init(&(ros_message->masks), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create segm_msgs__msg__Mask__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    segm_msgs__msg__Mask * dest = ros_message->masks.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!segm_msgs__msg__mask__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * segm_msgs__msg__obstacles__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("segm_msgs.msg._obstacles");
  ...
  {  // classes_ids
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "classes_ids");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->classes_ids.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->classes_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->classes_ids.size * sizeof(int32_t));
      assert(data != NULL);
  ...
  {  // masks
    ...
    segm_msgs__msg__Mask * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->masks.data[i]);
      PyObject * pyitem = segm_msgs__msg__mask__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
