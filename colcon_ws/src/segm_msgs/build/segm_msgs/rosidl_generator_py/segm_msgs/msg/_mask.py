...
class Mask(metaclass=Metaclass_Mask):
    ...
    def __init__(self, **kwargs):
        ...
        self.mask = array.array('B', kwargs.get('mask', []))
    ...
    def mask(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'mask' array.array() must have the type code of 'B'"
            self._mask = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'mask' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._mask = array.array('B', value)
