...
static const _Mask_type_support_symbol_names_t _Mask_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, segm_msgs, msg, Mask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, segm_msgs, msg, Mask)),
  }
};
...
{
  return &::segm_msgs::msg::rosidl_typesupport_cpp::Mask_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, segm_msgs, msg, Mask)() {
  return get_message_type_support_handle<segm_msgs::msg::Mask>();
}
