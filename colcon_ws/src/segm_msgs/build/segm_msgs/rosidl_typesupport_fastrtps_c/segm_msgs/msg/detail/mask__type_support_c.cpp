...
#include "segm_msgs/msg/detail/mask__rosidl_typesupport_fastrtps_c.h"
...
using _Mask__ros_msg_type = segm_msgs__msg__Mask;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: mask
  {
    ...
    if (ros_message->mask.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->mask);
    }
...
static uint32_t _Mask__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_segm_msgs__msg__Mask(
...
{
  return max_serialized_size_segm_msgs__msg__Mask(
    full_bounded, 0);
}
